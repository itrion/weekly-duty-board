...
**Tests**: The examples below include test tasks. Include them when requested by the
feature specification.
**Verification**: Constitution-aligned verification tasks are REQUIRED for every
feature (typecheck + impacted behavior checks, including print checks for UI changes).
...
- [ ] T004 Define verification tasks for constitution gates (contract, validation,
      data integrity, print/language if applicable)
...
- [ ] T011 Add/update shared route/schema contracts when feature changes API/data
...
- [ ] T018 [US1] Add boundary validation and error handling
- [ ] T019 [US1] Verify print/UI behavior and language copy for impacted views
- [ ] T020 [US1] Record verification evidence (`npm run check` + story checks)
...
- [ ] T027 [US2] Record verification evidence for impacted constitution gates
...
- [ ] T033 [US3] Record verification evidence for impacted constitution gates
